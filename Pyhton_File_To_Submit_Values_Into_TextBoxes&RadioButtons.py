...
driver.find_element(By.XPATH,'//*[@id="contact_form"]/fieldset/div[1]/div/div/input').send_keys("user")
driver.find_element(By.XPATH,'//*[@id="contact_form"]/fieldset/div[2]/div/div/input').send_keys("admin")
...
driver.find_element(By.XPATH, '//*[@id="contact_form"]/fieldset/div[5]/div/div/input').send_keys(" B-10 , Neveda,United States")
driver.find_element(By.XPATH, '//*[@id="contact_form"]/fieldset/div[6]/div/div/input').send_keys(" Neveda")
